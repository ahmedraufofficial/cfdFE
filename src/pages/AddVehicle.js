    ...
    return (
        <Grid>
            <Paper elevation={10} style={paperStyle}>
                <FormikStepper
                    initialValues={{
                        Vehicle_Manufacturer: "0" //from Material UI
                    }}
                    onSubmit={(values, { resetForm }) => {                    
                        try {
                            ...
                            dataValues.Manufacturing_Year = dataValues.Manufacturing_Year ? moment(dataValues.Manufacturing_Year).format('YYYY') : formattedDate;
                    ...
                    >
                        ...
                        <Grid style={gridStyle}><Field component={DatePicker} label="Manufacturing Year" name="Manufacturing_Year" inputFormat="MM/dd/yyyy" /></Grid>

                        <Grid style={gridStyle}><Field component={DatePicker} label="Year Of Registration" name="Year_Of_Registration" inputFormat="MM/dd/yyyy" /></Grid>
